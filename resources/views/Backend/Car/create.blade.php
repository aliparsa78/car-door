                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('cars.store')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="car_name" id="exampleInputEmail3" placeholder="Car Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Car Model</label>
                        <input type="text" class="form-control" name="car_model" id="exampleInputPassword4" placeholder="Car Model">
                      </div>
                      <div class="form-group">
                        <label >Car Color</label>
                        <input type="text" class="form-control" name="car_color" id="" placeholder="Car Color">
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Car Plate Number</label>
                        <input type="text" class="form-control" name="plate_number" id="exampleInputPassword4" placeholder="Plate Number">
                        
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Price Per Day</label>
                        <input type="number" class="form-control" name="price_perday" id="exampleInputPassword4" placeholder="Price">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="details" id="exampleTextarea1" rows="4"></textarea>
                      </div>
